...
void set_opcodes(struct opcode** opcodes_ptr, struct address** addresses_ptr)
{
  ...
  (*addresses_ptr) = malloc(17 * sizeof(struct address));
  ...
  unsigned char ABSOLUTE_Y_NOCYCLE_ADDRESS_MODE = 15;
  unsigned char ABSOLUTE_X_NOCYCLE_ADDRESS_MODE = 16; 
  ...
  (*addresses_ptr)[15].program_counter_increment = 3;
  (*addresses_ptr)[15].get_operand_ptr = get_absolute_Y_nocycle_operand_ptr;
  (*addresses_ptr)[15].address_info = "$%02X%02X,Y";
  (*addresses_ptr)[15].inc_pc = 1;

  (*addresses_ptr)[16].program_counter_increment = 3;
  (*addresses_ptr)[16].get_operand_ptr = get_absolute_X_nocycle_operand_ptr;
  (*addresses_ptr)[16].address_info = "$%02X%02X,X";
  (*addresses_ptr)[16].inc_pc = 1;
  for(int i=0; i<256; i++)
  {
  ...
  set_opcode(opcodes_ptr, 0x03, "SLO", SLO, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  set_opcode(opcodes_ptr, 0x04, "NOP", NOP, ZEROPAGE_ADDRESS_MODE, 3);
  ...
  set_opcode(opcodes_ptr, 0x07, "SLO", SLO, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0x0c, "NOP", NOP, ABSOLUTE_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x0f, "SLO", SLO, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x13, "SLO", SLO, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x14, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x17, "SLO", SLO, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x1b, "SLO", SLO, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0x1c, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x1d, "ORA", ORA_ptr, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x1e, "ASL", ASL, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x1f, "SLO", SLO, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  ...
  set_opcode(opcodes_ptr, 0x23, "RLA", RLA, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  ...
  set_opcode(opcodes_ptr, 0x27, "RLA", RLA, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0x2f, "RLA", RLA, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x33, "RLA", RLA, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x34, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x37, "RLA", RLA, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x3b, "RLA", RLA, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0x3c, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x3d, "AND", AND_ptr, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x3e, "ROL", ROL, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x3f, "RLA", RLA, ABSOLUTE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x43, "SRE", SRE, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  set_opcode(opcodes_ptr, 0x44, "NOP", NOP, ZEROPAGE_ADDRESS_MODE, 3);
  ...
  set_opcode(opcodes_ptr, 0x47, "SRE", SRE, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0x4f, "SRE", SRE, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x53, "SRE", SRE, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x54, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x57, "SRE", SRE, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x5b, "SRE", SRE, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0x5c, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x5d, "EOR", EOR_ptr, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x5e, "LSR", LSR, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x5f, "SRE", SRE, ABSOLUTE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x63, "RRA", RRA, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  set_opcode(opcodes_ptr, 0x64, "NOP", NOP, ZEROPAGE_ADDRESS_MODE, 3);
  ...
  set_opcode(opcodes_ptr, 0x67, "RRA", RRA, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0x6f, "RRA", RRA, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x73, "RRA", RRA, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x74, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x77, "RRA", RRA, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x7b, "RRA", RRA, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0x7c, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x7d, "ADC", ADC_ptr, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x7e, "ROR", ROR, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0x7f, "RRA", RRA, ABSOLUTE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x83, "SAX", SAX, INDEXED_INDIRECT_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0x87, "SAX", SAX, ZEROPAGE_ADDRESS_MODE, 3);
  ...
  set_opcode(opcodes_ptr, 0x8f, "SAX", SAX, ABSOLUTE_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0x97, "SAX", SAX, ZEROPAGE_Y_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0x98, "TYA", TYA, NONE_ADDRESS_MODE, 2);
  set_opcode(opcodes_ptr, 0x99, "STA", STA_ptr, ABSOLUTE_Y_NOCYCLE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0x9d, "STA", STA_ptr, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0xa3, "LAX", LAX, INDEXED_INDIRECT_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xa7, "LAX", LAX, ZEROPAGE_ADDRESS_MODE, 3);
  ...
  set_opcode(opcodes_ptr, 0xaf, "LAX", LAX, ABSOLUTE_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xb3, "LAX", LAX, INDIRECT_INDEXED_Y_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0xb7, "LAX", LAX, ZEROPAGE_Y_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xbc, "LDY", LDY, ABSOLUTE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xbf, "LAX", LAX, ABSOLUTE_Y_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xc3, "DCP", DCP, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  ...
  set_opcode(opcodes_ptr, 0xc7, "DCP", DCP, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0xcf, "DCP", DCP, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xd3, "DCP", DCP, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0xd4, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xd7, "DCP", DCP, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xdb, "DCP", DCP, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0xdc, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xdf, "DCP", DCP, ABSOLUTE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xe3, "ISB", ISC, INDEXED_INDIRECT_X_ADDRESS_MODE, 8);
  ...
  set_opcode(opcodes_ptr, 0xe7, "ISB", ISC, ZEROPAGE_ADDRESS_MODE, 5);
  ...
  set_opcode(opcodes_ptr, 0xef, "ISB", ISC, ABSOLUTE_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xf3, "ISB", ISC, INDIRECT_INDEXED_Y_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0xf4, "NOP", NOP, ZEROPAGE_X_ADDRESS_MODE, 4);
  ...
  set_opcode(opcodes_ptr, 0xf7, "ISB", ISC, ZEROPAGE_X_ADDRESS_MODE, 6);
  ...
  set_opcode(opcodes_ptr, 0xfb, "ISB", ISC, ABSOLUTE_Y_ADDRESS_MODE, 6);
  set_opcode(opcodes_ptr, 0xfc, "NOP", NOP, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0xfd, "SBC", SBC_ptr, ABSOLUTE_X_ADDRESS_MODE, 4);
  set_opcode(opcodes_ptr, 0xfe, "INC", INC, ABSOLUTE_X_NOCYCLE_ADDRESS_MODE, 7);
  set_opcode(opcodes_ptr, 0xff, "ISB", ISC, ABSOLUTE_X_ADDRESS_MODE, 6);
